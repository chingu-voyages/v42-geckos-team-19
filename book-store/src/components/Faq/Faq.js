    ...
    <Container maxW="100%" mt={{ base: 250, md: 700 }} mb="200">
      ...
      >
        <Box
          ...
          mb={{ base: "25px", md: "0" }}
        >
          <Accordion allowToggle p="40px" mb="20px" borderColor="#d9d9d9">
            <chakra.h2
              fontSize="40px"
              pl="20px"
              pb="20px"
            ...
            <AccordionItem>
              ...
              <AccordionPanel pb={4} fontFamily="Poppins">
                ...
                enim ad minim veniam, quis nostrud exercitation ullamcon laboris
            ...
            <AccordionItem>
              <h2>
                <AccordionButton
                  _expanded={{ color: "#E4573D", fontWeight: "bold" }}
                >
                  <Box
                    as="span"
                    flex="1"
